...
{
    public partial class Cbeoc1TobjSegcontainscp2
    {
        ...
        public string InvoiceAddressPostalAddressLine { get; set; }
        public string InvoiceAddressPostalStreet { get; set; }
        public string InvoiceAddressPostalStreetNumber { get; set; }
        public string InvoiceAddressPostalCode { get; set; }
        public string InvoiceAddressPostalCity { get; set; }
        public short? InvoiceAddressPostalCountry { get; set; }
        public string Education { get; set; }
        public string ArticleHolder { get; set; }
        public string Predecessor { get; set; }
        public string Successor { get; set; }
        public string EducationName { get; set; }
        public short? PositionState { get; set; }
        public short? PositionStateSuccessor { get; set; }
