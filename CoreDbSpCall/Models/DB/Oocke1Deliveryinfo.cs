...
{
    public partial class Oocke1Deliveryinfo
    {
        ...
        public decimal? DeliveryTempCelcius { get; set; }
        public string Description { get; set; }
        public string Feedback { get; set; }
        public string Name { get; set; }
        public decimal? QuantityBeforeDelivery { get; set; }
        public decimal? QuantityShipped2 { get; set; }
        public string UomQuantityBeforeDelivery { get; set; }
        public string UomQuantityShipped { get; set; }
        public string UomQuantityShipped2 { get; set; }
