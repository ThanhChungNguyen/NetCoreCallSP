...
{
    public partial class Oocke1Activitygroup
    {
        ...
        public int? EstimateEffortMinutes { get; set; }
        public int? EstimateMaxDeviation { get; set; }
        public int ExternalLink { get; set; }
        public int ModifiedBy { get; set; }
        public string Name { get; set; }
        public int Owner { get; set; }
        public string PParent { get; set; }
        public int? SumEstimateEffortHours { get; set; }
        public int? SumEstimateEffortMinutes { get; set; }
        ...
        public short? ActivityGroupType { get; set; }
        public string MainActivity { get; set; }
        public string TargetGroupAccounts { get; set; }
