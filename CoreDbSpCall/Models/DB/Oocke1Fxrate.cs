...
{
    public partial class Oocke1Fxrate
    {
        ...
        public short? CurrencyBuy { get; set; }
        public short? CurrencySell { get; set; }
        public string Description { get; set; }
        public bool? Disabled { get; set; }
        public string DisabledReason { get; set; }
        public int? ExternalLink { get; set; }
        public string FxRateProvider { get; set; }
        public short? FxRateType { get; set; }
        public int? ModifiedBy { get; set; }
        public string Name { get; set; }
        public int? Owner { get; set; }
        public decimal? Rate { get; set; }
        public string PParent { get; set; }
        public decimal? TransactionSizeFrom { get; set; }
        public decimal? TransactionSizeTo { get; set; }
