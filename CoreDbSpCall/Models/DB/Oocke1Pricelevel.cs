...
{
    public partial class Oocke1Pricelevel
    {
        ...
        public int? DefaultOffsetValidFromHh { get; set; }
        public int? DefaultOffsetValidToHh { get; set; }
        public string ProductPhaseKey { get; set; }
