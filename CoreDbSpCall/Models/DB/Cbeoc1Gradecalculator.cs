...
namespace CoreDbSpCall.Models.DB
{
    public partial class Cbeoc1Gradecalculator
    {
        ...
        public int? ParamDefaultValue { get; set; }
        public int? ParamLabel { get; set; }
        public int? ParamName { get; set; }
        public int? ParamPattern { get; set; }
